...
For the posts metadata, I use [frontmatter](https://mdxjs.com/guides/frontmatter/#frontmatter), which is included in the MDX toolset. This handy library allows me to include metadata like title, post date or tags right at the top of the `.mdx` files.
